...
The format of a requirement is described in the next section [Requirement description template](https://eclipse-ankaios.github.io/ankaios/main/development/requirement-template/index.md).

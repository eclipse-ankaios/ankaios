...
Or you can also configure the mTLS certificates in the CLI configuration file `~/.config/ankaios/ank.conf`. In any case you should set `insecure = false` in there to prevent a warning when mTLS certificates are provided.

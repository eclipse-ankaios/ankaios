...
impl SignCommand {
    ...
    fn parse_ed25519_private_key(&self, pem_content: &str) -> Result<SigningKey, String> {
        let key_array = common::pem_utils::parse_ed25519_private_key_pem(pem_content)?;
    ...
    fn load_next_counter(&self) -> Result<u64, String> {
        common::path_security::validate_safe_name(&self.key_id)
            .map_err(|e| format!("Invalid key_id for counter file: {}", e))?;

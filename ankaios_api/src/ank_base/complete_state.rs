...
mod tests {
    ...
    fn utest_serialize_state_into_ordered_output() {
        ...
        let index_workload1 = sorted_state_string.find(vars::WORKLOAD_NAMES[0]).unwrap();
        let index_workload2 = sorted_state_string.find(vars::WORKLOAD_NAMES[1]).unwrap();
        assert!(

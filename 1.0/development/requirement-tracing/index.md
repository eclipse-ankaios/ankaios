...
The format of a requirement is described in the next section [Requirement description template](https://eclipse-ankaios.github.io/ankaios/1.0/development/requirement-template/index.md).

...
For a basic example of separating configurations from workloads, see [here](https://eclipse-ankaios.github.io/ankaios/1.0/reference/startup-configuration/index.md). For detailed information about using the `files` field, see [here](https://eclipse-ankaios.github.io/ankaios/1.0/usage/manifest/workload-files/index.md).

...
More information on the control interface authorization can be found in the [reference documentation](https://eclipse-ankaios.github.io/ankaios/1.0/reference/control-interface/#authorization).

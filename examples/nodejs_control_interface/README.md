# Ankaios Control Interface Communcation with Nodejs
...
```shell
 docker run -it --rm -v /absolute/path/to/examples/config:/workspaces/app/config -v /absolute/path/to/examples/scripts:/workspaces/app/scripts -v /absolute/path/to/examples/nodejs_control_interface:/workspaces/app --workdir /workspaces/app --privileged ghcr.io/eclipse-ankaios/app-ankaios-dev:latest /bin/bash
```

...
mod tests {
    ...
    fn utest_containerd_config_failure_missing_image() {
        let mut workload = generate_test_workload_with_params(AGENT_NAME, CONTAINERD_RUNTIME_NAME);
    ...
    fn utest_containerd_config_failure_wrong_runtime() {
        let workload = generate_test_workload_with_params(AGENT_NAME, DIFFERENT_RUNTIME_NAME);

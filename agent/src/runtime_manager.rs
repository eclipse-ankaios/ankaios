...
mod tests {
    ...
    use api::ank_base::{
        self, AddCondition, CompleteState, ExecutionStateInternal, Files, Response,
        ResponseContent, WorkloadInstanceNameBuilder, WorkloadInstanceNameInternal,
        WorkloadInternal,
    };
    use api::test_utils::{
    ...
    async fn utest_handle_update_workload_initial_call_handle() {
        ...
        let new_workload_access = generate_test_workload_with_control_interface_access(
            AGENT_NAME.to_string(),
            WORKLOAD_1_NAME.to_string(),
            RUNTIME_NAME.to_string(),
        );

        let new_workload_no_access = generate_test_workload_with_param(
            AGENT_NAME.to_string(),
    ...
    async fn utest_handle_update_workload_no_workload_with_unknown_runtime() {
        ...
        let workload_with_unknown_runtime = generate_test_workload_with_control_interface_access(
            AGENT_NAME.to_string(),
            WORKLOAD_1_NAME.to_string(),
    ...
    async fn utest_handle_update_workload_initial_call_failed_to_get_reusable_workloads() {
        ...
        let workload = generate_test_workload_with_control_interface_access(
            AGENT_NAME.to_string(),
            WORKLOAD_1_NAME.to_string(),
            RUNTIME_NAME.to_string(),
        );
    ...
    async fn utest_update_workload_test_control_interface_creation() {
        ...
        control_interface_info_new_context
            ...
            .once()
            .return_once(|_, _, _, _| MockControlInterfaceInfo::default());
        let workload_spec_no_access = generate_test_workload_with_param(
            AGENT_NAME.to_string(),
            WORKLOAD_1_NAME.to_string(),
            RUNTIME_NAME.to_string(),
        );
        ...
        let workload_spec_has_access = generate_test_workload_with_control_interface_access(
            AGENT_NAME.to_string(),
            WORKLOAD_1_NAME.to_string(),
            RUNTIME_NAME.to_string(),
        );
    ...
    async fn utest_resume_existing_running_workload_with_equal_config() {
        ...
        let existing_workload = generate_test_workload_with_control_interface_access(
            AGENT_NAME.to_string(),
            WORKLOAD_1_NAME.to_string(),
            RUNTIME_NAME.to_string(),
        );
    ...
    async fn utest_replace_existing_workload_with_different_config() {
        ...
        assert!(runtime_manager.workloads.contains_key(WORKLOAD_1_NAME)); // existing workload is resumed
    }
    ...
    async fn utest_replace_existing_not_running_workload_after_agent_restart() {
        ...
        let existing_workload = generate_test_workload_with_param(
            AGENT_NAME.to_string(),
            WORKLOAD_1_NAME.to_string(),
            RUNTIME_NAME.to_string(),
        );
    ...
    async fn utest_replace_existing_not_running_workload_after_server_restart() {
        ...
        runtime_manager
            .workloads
            .insert(WORKLOAD_1_NAME.to_owned(), MockWorkload::default()); // workload is known
    ...
    async fn utest_handle_update_workload_initial_call_add_workload_with_unfulfilled_dependencies()
    {
        ...
        let added_workloads = vec![generate_test_workload_with_param(
            AGENT_NAME.to_string(),
            WORKLOAD_1_NAME.to_string(),
            RUNTIME_NAME.to_string(),
        )];
    ...
    async fn utest_handle_update_workload_subsequent_update_on_add_and_delete() {
        ...
        let new_workload = generate_test_workload_with_control_interface_access(
            AGENT_NAME.to_string(),
            WORKLOAD_1_NAME.to_string(),
            RUNTIME_NAME.to_string(),
        );
        ...
        workload_mock
            ...
            .once()
            .with(
                predicate::function(|workload_spec: &Option<WorkloadInternal>| {
    ...
    async fn utest_update_workload_state_create_workload_with_fulfilled_dependencies() {
        ...
        let mut workload_spec = generate_test_workload_with_dependencies(
            AGENT_NAME,
            WORKLOAD_1_NAME,
            RUNTIME_NAME,

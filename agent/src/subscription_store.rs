...
mod tests {
    ...
    fn utest_overwrite_drops_old_element() {
        ...
        subscription_store.add_subscription(vars::WORKLOAD_IDS[0].into(), subscription_entry_1);
        subscription_store.add_subscription(vars::WORKLOAD_IDS[1].into(), subscription_entry_2);
        ...
        subscription_store.add_subscription(vars::WORKLOAD_IDS[1].into(), new_subscription_2);

        assert!(subscription_store.store.contains_key(vars::WORKLOAD_IDS[0]));
        assert!(subscription_store.store.contains_key(vars::WORKLOAD_IDS[1]));
    }

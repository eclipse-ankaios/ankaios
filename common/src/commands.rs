...
mod tests {
    ...
    mod ank_base {
        pub use api::ank_base::{
            ...
            UpdateStateRequest, Workload, WorkloadInstanceName, WorkloadMap, LogsCancelRequest,
        };
    }
    ...
    mod ankaios {
        pub use crate::{
            commands::{
                CompleteStateRequest, LogsRequest, Request, RequestContent,
                UpdateStateRequest, LogsCancelRequest,
            },
            objects::{
